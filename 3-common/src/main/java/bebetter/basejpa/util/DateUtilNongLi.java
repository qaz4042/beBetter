...
public class DateUtilNongLi {
     ...
     */
    @SneakyThrows
    public DateUtilNongLi(Date date) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        String d = dateFormat.format(date);
        Calendar cal = Calendar.getInstance();
        cal.setTime(chineseDateFormat.parse(d));
...
/*
    ...
    public static void main(String[] args) {
        Date now = new Date();
        DateUtilNongLi lunar = new DateUtilNongLi(now);

        System.out.println("公历：" + chineseDateFormat.format(now.getTime()) + ",农历" + lunar);
        System.out.println("什么年(生肖)：" + lunar.animalsYear() + ",什么年(天干地支)：" + lunar.cyclical());
    }
*/
